...
sealed class ValidationError(open val message: String) {
    ...
    data class InvalidKernelVersion(val version: String) : ValidationError("Invalid kernel version: $version")
    data class InvalidKernelPath(val path: String) : ValidationError("Invalid kernel path: $path")
    ...
    data class InvalidSubvolumeName(val name: String) : ValidationError("Invalid subvolume name: $name")
